...
%	\vspace*{2.0\multicolsep}
	...
	\resumeItem{Evaluated the completed surveys using statistical techniques such as conjoint method, clustering analysis, ANOVA, hypothesis testing as well as post-hoc difference test, and provided the results to the clients via presentation decks.}
	\resumeItemListEnd
